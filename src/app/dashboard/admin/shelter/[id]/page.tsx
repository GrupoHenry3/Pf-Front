                      ...
                      {shelterPets.slice(0, 6).map((pet) => (
                        <div key={pet.id} className="flex items-center space-x-3 p-3 border rounded-lg">
                          ...
                          <div className="flex-1">
                            ...
                            <Badge 
                              variant={getPetStatusVariant(getPetStatus(pet))}
                              className="text-xs"
                            >
                              {getPetStatusLabel(getPetStatus(pet))}
                            </Badge>
                          </div>
                        </div>
                      ))}
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {shelterPets.filter(p => getPetStatus(p) === 'available').length}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Adoptadas:</span>
                    <span className="font-semibold">
                      {shelterPets.filter(p => getPetStatus(p) === 'adopted').length}
                    </span>
                  </div>
                  <div className="flex justify-between">
